...
def analyze_interrater_reliability():
    ...
    for index_data_folder,data_folder in enumerate(data_folders):
        ...
        answers, results_csv, all_coord_chest, all_coord_box, all_certainty_box,all_index_box = get_classes_from_csv(data_folder +'/structured_output.csv', results_csv, user, 'phase_3_transcriptions.csv')
