        ...
        for document in documents:
            ...
            for annotation in impression_passage.annotations:
                ...
                if label in [UNCERTAIN, POSITIVE]:
                    location[category] += [[location_.offset,location_.offset+location_.length] for location_ in annotation.locations ]
            ...
            for index, category in enumerate(CATEGORIES):
                locations[category].append(location[category])

        return np.array(labels), locations
