# generates a table summarizing the eye tracking data for all the phases, one table for each phase. These tables are read by the create_main_table script
# this script needs the tables generated by the analyze_interrater_....py and also a table discard_cases.csv listing the cases to be discarded
