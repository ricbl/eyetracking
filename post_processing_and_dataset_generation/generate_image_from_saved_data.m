...
% generates a copy of the screen where radiologists drew ellipses to localize anomalis, without the buttons. 
% The inputs to the function are a list of the properties of all the labels chosen by the radiologists.
% The call to the function can be generated by the analyze_interrater_....py scripts
%
